...
use egui_graphs::{
    DisplayEdge, DisplayNode, Node,
    draw::{DrawContext, displays_default::edge_shape_builder::*},
    elements::EdgeProps,
    node_size,
};

use crate::VisualEdge;

#[derive(Clone, Debug)]
pub struct AppEdgeShape<E> {
    pub order: usize,
    pub selected: bool,
...
impl<E: Clone> From<EdgeProps<E>> for AppEdgeShape<E> {
...
impl<N: Clone, Ty: EdgeType, Ix: IndexType, D: DisplayNode<N, E, Ty, Ix>>
    DisplayEdge<N, E, Ty, Ix, D> for AppEdgeShape<E>
{
    fn is_inside(
        &self,
    ...
    fn shapes(
        ...
        let color = style
            .fg_stroke
            .color
            .blend(if self.payload.mapped {
                Color32::ORANGE.gamma_multiply(0.2)
            } else {
                Color32::CYAN.gamma_multiply(0.2)
            })
            .gamma_multiply(0.8);
...
impl<E: Clone> AppEdgeShape<E> {
    fn is_inside_loop<N: Clone, Ix: IndexType, Ty: EdgeType, D: DisplayNode<N, E, Ty, Ix>>(
        &self,
    ...
    fn is_inside_line<N: Clone, Ix: IndexType, Ty: EdgeType, D: DisplayNode<N, E, Ty, Ix>>(
        &self,
        start: &Node<N, E, Ty, Ix, D>,
        end: &Node<N, E, Ty, Ix, D>,
        pos: Pos2,
    ...
    fn is_inside_curve<N: Clone, Ty: EdgeType, Ix: IndexType, D: DisplayNode<N, E, Ty, Ix>>(
        &self,
